...
var Editor$1 = function (_React$Component) {
  ...
  function Editor$$1() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Editor$$1.__proto__ || Object.getPrototypeOf(Editor$$1)).call.apply(_ref, [this].concat(args))), _this), _initialiseProps$4.call(_this), _temp), possibleConstructorReturn(_this, _ret);
  }
  /**
   * Property types.
   *
...
var _initialiseProps$4 = function _initialiseProps() {
  ...
  this.resolveController = memoizeOne(function () {
    ...
    _this2.controller = new Editor(attrs, { editor: _this2, normalize: false });
  });
