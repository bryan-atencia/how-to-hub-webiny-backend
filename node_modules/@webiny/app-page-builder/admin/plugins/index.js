...
export default (function () {
  return [header, revisionContent, previewContent, pageRevisions, menuItems, globalSearch, settings, routes, menus, scopesList, install, appTemplatePlugins, welcomeScreenWidget];
});
