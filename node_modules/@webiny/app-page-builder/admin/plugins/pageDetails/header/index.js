...
var plugins = [{
  ...
  render: function render(props) {
    return /*#__PURE__*/React.createElement(PublishRevision, props);
  }
}, {
  name: "pb-page-details-header-edit",
  type: "pb-page-details-header-right",
  render: function render(props) {
    return /*#__PURE__*/React.createElement(EditRevision, props);
  }
}, {
  name: "pb-page-details-header-delete",
  type: "pb-page-details-header-right",
  render: function render(props) {
    return /*#__PURE__*/React.createElement(DeletePage, props);
  }
}, {
  name: "pb-page-details-header-options-menu",
  type: "pb-page-details-header-right",
  render: function render(props) {
    return /*#__PURE__*/React.createElement(PageOptionsMenu, props);
  }
}];
