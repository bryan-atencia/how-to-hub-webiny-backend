...
export default (function () {
  return [install, routes, menus, icons, header, revisionContent, contentForm, contentRevisions, // Editor
  fields, fieldRenderers, validators, contentModelEditorPlugins, appTemplateRenderer, welcomeScreenWidget];
});
