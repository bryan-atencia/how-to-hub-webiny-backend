...
var FormSettings = function FormSettings(_ref) {
  ...
  var plugins = getPlugins("form-editor-form-settings");
  ...
  return /*#__PURE__*/React.createElement(OverlayLayout, {
    ...
    data: data.settings,
    onSubmit: function onSubmit(settings) {
