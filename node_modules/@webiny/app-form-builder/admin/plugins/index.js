...
export default (function () {
  return [install, settings, routes, menus, formSubmissions, previewContent, formRevisions, scopesList, // Editor
  fields, groups, validators, formEditorPlugins, formSitePlugins(), welcomeScreenWidget];
});
