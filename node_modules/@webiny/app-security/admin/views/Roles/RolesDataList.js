...
function _templateObject() {
  var data = _taggedTemplateLiteral(["Security Roles"]);
...
import { DataList, ScrollList, ListItem, ListItemText, ListItemTextSecondary, ListItemMeta, ListActions } from "@webiny/ui/List";
var t = i18n.ns("app-security/admin/roles/data-list");

var RolesDataList = function RolesDataList() {
  ...
  return /*#__PURE__*/React.createElement(DataList, Object.assign({}, list, {
    ...
    return /*#__PURE__*/React.createElement(ScrollList, {
      ...
      }, item.name, /*#__PURE__*/React.createElement(ListItemTextSecondary, null, item.description)), /*#__PURE__*/React.createElement(ListItemMeta, null, /*#__PURE__*/React.createElement(ListActions, null, /*#__PURE__*/React.createElement(ConfirmationDialog, null, function (_ref2) {
