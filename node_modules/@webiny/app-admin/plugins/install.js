...
function _templateObject5() {
  var data = _taggedTemplateLiteral(["File Manager app"]);
...
function _templateObject3() {
  var data = _taggedTemplateLiteral(["Installing File Manager..."]);
...
var t = i18n.ns("app-admin/admin/installation");
...
var FMInstaller = function FMInstaller(_ref) {
  ...
  useEffect(function () {
    client.mutate({
      ...
      var data = _ref2.data;
      var error = data.files.install.error;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              return _context.abrupt("return", data.files.isInstalled.data);
