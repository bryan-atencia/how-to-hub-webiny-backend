...
import dialog from "@webiny/app-admin/plugins/Dialog"; // Header plugins
...
import { globalSearch, globalSearchHotkey } from "@webiny/app-admin/plugins/GlobalSearch"; // User menu plugins
...
export default (function () {
  ...
  Header, Content, snackbar("admin-layout-component"), dialog("admin-layout-component"), // Header plugins
  Menu, Logo, FileManager, UserMenu, globalSearch, globalSearchHotkey, DarkMode, DefaultHandle, Help, SendFeedback, install, init];
});
